...
## When to Use
- When you want to use a prompt like a folder
- When you want to group related prompts together for organization

## What It Does
Sets the selected prompt as a group (folder icon). Groups are displayed with a green folder icon.

## How to Use
1. Select the prompt you want to set as a group
