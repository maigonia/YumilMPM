...
| Topic | Summary |
|---|---|
| [File](File/) | Project file operations and backups |
| [CategoryTree](CategoryTree/) | Category tree management |
| [PromptTree](PromptTree/) | Prompt tree authoring and selection |
| [PromptEditor](PromptEditor/) | Prompt editor with auto-complete, syntax highlight, and Programmable Block support |
| [PromptBrowser](PromptBrowser/) | Browse selected prompt details (image, memo, tag) |
| [PromptGeneration](PromptGeneration/) | Generation modes, queue patterns, and external app integration |
