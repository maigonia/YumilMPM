...
- Open from the gear icon in [EditPlugin Settings](../../../GlobalSettings/04-Menu/03-EditPlugin Settings/01-EditPlugin Settings.md)
- Can also be opened from the gear icon next to Exclude Tags Preset in [WD14 Tagger Settings](../../../GlobalSettings/04-Menu/03-EditPlugin Settings/04-WD14 Tagger.md)
...
By passing a preset name as the second argument of [env.WD14](../../02-How To Write Prompt Content/02-How To Write Programmable Block/02-Built-in Functions/14-env.WD14.md), automatic filtering can be applied during tag extraction:
...
- [env.WD14](../../02-How To Write Prompt Content/02-How To Write Programmable Block/02-Built-in Functions/14-env.WD14.md)
