...
## Memory Limits
The sandbox has a configurable memory limit. This prevents scripts from consuming excessive memory and destabilizing the app.

- Default: 512 MB
- Configurable range: 128 MB - 16 GB
