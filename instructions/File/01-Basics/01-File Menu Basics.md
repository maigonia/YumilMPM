...
The File menu handles project creation/management and backups.

## What Is a Project

In this app, all work data is managed in units called "projects."
Prompts, categories, images, settings, and everything you create are all contained in a single folder.

To start anything, you need to either create a project or open an existing one.
...
Changes made during work are not saved immediately. When **File > AutoSave on Application Close** (enabled by default) is on, changes are saved together when the app closes.
...
A backup feature is provided for emergencies.
