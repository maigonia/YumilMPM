...
- The copied folder can be opened directly via [Open Project](../02-Menu/02-Open Project.md)
- For backup purposes, also consider [Full Backup](../02-Menu/09-BackUp/01-Full Backup.md) / [Create Backup](../02-Menu/09-BackUp/02-Quick Backup/01-Create Backup Quick Backup.md)
...
1. Quit the app (or close the target project via [Close Project](../02-Menu/05-Close Project.md))
...
4. Open the new project in the app via [Open Project](../02-Menu/02-Open Project.md)
...
- Always create a backup with [Create Backup](../02-Menu/09-BackUp/02-Quick Backup/01-Create Backup Quick Backup.md) before editing
...
- The data location can be opened in Explorer via [Open Data Folder](../02-Menu/07-Open Data Folder.md)
